...
#include "htdist/bootstrap_5_0_1_min_css_gz.h"
...
#include "htdist/bootstrap_5_0_1_min_js_gz.h"
...
static void web_path_bootstrap_5_0_1_min_css(struct netconn *conn)
{
  netconn_write(conn, http_css_gz_hdr, sizeof(http_css_gz_hdr)-1, NETCONN_NOCOPY);
  netconn_write(conn, bootstrap_5_0_1_min_css_gz, bootstrap_5_0_1_min_css_gz_len, NETCONN_NOCOPY);
}
...
static void web_path_mithril_2_0_4_min_js(struct netconn *conn)
{
  netconn_write(conn, http_javascript_gz_hdr, sizeof(http_javascript_gz_hdr)-1, NETCONN_NOCOPY);
  netconn_write(conn, mithril_2_0_4_min_js_gz, mithril_2_0_4_min_js_gz_len, NETCONN_NOCOPY);
}

static void web_path_bootstrap_5_0_1_min_js(struct netconn *conn)
{
  netconn_write(conn, http_javascript_gz_hdr, sizeof(http_javascript_gz_hdr)-1, NETCONN_NOCOPY);
  netconn_write(conn, bootstrap_5_0_1_min_js_gz, bootstrap_5_0_1_min_js_gz_len, NETCONN_NOCOPY);
}
...
void web_paths_get(struct netconn *conn, char *url_buffer)
{
  ...
  {
    web_path_mithril_2_0_4_min_js(conn);
  }
  else if(strcmp("/bootstrap_5.0.1.min.js", url_buffer) == 0)
  {
    web_path_bootstrap_5_0_1_min_js(conn);
  }
  else if(strcmp("/bootstrap_5.0.1.min.css", url_buffer) == 0)
  {
    web_path_bootstrap_5_0_1_min_css(conn);
  }
